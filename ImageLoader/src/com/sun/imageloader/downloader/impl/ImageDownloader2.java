...
//ImageDownloader2 HTTPImageStreamRereiever
public class ImageDownloader2 implements ImageRetriever{
	...
	public ImageDownloader2(int maxTimeOut_, int maxReadTimeOut_, int maxRedirectCount_) {
